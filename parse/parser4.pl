...
sub create_node_from_phrase {
	...
	my $node_value = { '_broadcast' => 1, pos => [$pos_x,$pos_y,0], rot => [0,0,0], scl => [1,1,1], id => Grids::UUID->new_id, room_id => $room, attr => { type => 'GenericNode', text => $phrase->text } };
